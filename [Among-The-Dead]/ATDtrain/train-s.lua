...
{"ВСС mag",30},
{"M4A1 mag",30},
{"Большой сухой паёк",3},
{"Маленький сухой паёк",5},
{"Бинты",10},
{"Сигнальный Фаер",10},
{"Полная Канистра",20},
{"Аптечка",5},
...
{"Рюкзак АБРИС 60",5},
{"Рюкзак КОММАНДЕР 80",4},
{"Рюкзак СЛЕДОПЫТ 100",3},
{"Рюкзак КОЛОРАДО 120",2},
{"Рюкзак РУССКИЙ 140",1},
{"Мина",5},
...
addCommandHandler("trainIvent", makeTrain)
