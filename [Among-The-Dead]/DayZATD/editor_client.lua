...
{"Remington 870 (flashlight)",1910,"M1014 Pellet",25,8},
...
{"ВСС Винторез",1922,"ВСС mag",30,30},
...
-- ID,Колеса,мотор,расход топлива,MAX fuel,slots
vehicleAddonsInfo = {
