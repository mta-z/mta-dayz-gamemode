...
{"Пулеметы(черный рынок)"},
{"Снайперские винтовки(черный рынок)"},
...
["Прочее(черный рынок)"] = {
{"Мешок с частями зомби",11000},
},

["Одежда(черный рынок)"] = {
{"Военный шлем 50%",10000},
{"Бронешлем 70%",12000},
{"Бронешлем 80%",17000},
{"Бронежилет 20%",25000},
{"Бронежилет 30%",35000},
...
{"Жареная рыба",7000},
--{"Пицца",1524},
{"Большой сухой паёк",5000},
{"Маленький сухой паёк",4000},

},
["Вода"] = {
{"Пустая Фляга",1000}, 
{"Газированная Вода",500},
{"Кола",650},
},
["Медикаменты"] = {
...
{"Сигнальный Фаер",350},
{"Пустая Канистра",700},
--{"Колючая Проволка",184},
--{"Мешки с песком",30000},
{"Колесо",2200},
{"Мотор",3300},
{"Дрова",150},
{"Удочка",20000},
...
{"Дрова",200},
{"Палатка",3000},
{"Металлический ковш 1",10000},
{"Металлический ковш 2",12000},
{"Стальной лист",5000},
},
["Одежда"] ={

{"Одежда: Военный 1",5000},
{"Одежда: Военный 2",5300},
{"Одежда: Военный 3",5600},
{"Одежда: Военный 4",5100},
{"Одежда: Военный 5",5200},
{"Одежда: Военный 6",5050},
{"Одежда: Военный 7",5010},
{"Одежда: Военный 8",5000},
{"Одежда: Выживший 1",3500},
{"Одежда: Выживший 2",3500},
{"Одежда: Выживший 3",3200},
{"Одежда: Выживший 4",3100},
{"Одежда: Выживший 5",3200},
{"Одежда: Выживший 6",3010},
{"Одежда: Выживший 7",3050},
{"Одежда: Снайпер 1",7200},
{"Одежда: Снайпер 2",7600},
{"Одежда: Снайпер 3",7100},
{"Одежда: Снайпер 4",7200},

{"Мотошлем 10%",2800},
{"Сварочная маска 10%",2600},
{"Шахтерская каска 5%",1800},
...
["Рюкзаки"] = {
{"Рюкзак САТУРН 20",8000},
{"Рюкзак ШТУРМОВОЙ 40",10000},
{"Рюкзак АБРИС 60",12000},
{"Рюкзак КОММАНДЕР 80",14000},
{"Рюкзак СЛЕДОПЫТ 100",16000},
{"Рюкзак КОЛОРАДО 120",18000},
{"Рюкзак РУССКИЙ 140",20000},
--{"Рюкзак САМУРАЙ 160",25000},
--{"Рюкзак ВОЕННЫЙ 180",35000},
--{"Рюкзак ФАРАОН 200",45000},

},
["Инструменты"] = {
{"Прибор Ночного Виденья",1500},
{"Инфракрасное Виденье",2000},
{"Карта",521},
{"Спички",20},
{"Часы",100},
{"Навигатор",1000},
...
guiSetText ( YourMoneyText, getElementData(getLocalPlayer(),"Деньги") or "N/A" )
...
-- zadan= guiCreateGridList(10, 26, 200, 300, false, sess)
 ...
 scrollpane = guiCreateStaticImage(10,340,250,115, "scrollmenu_1.png", false, targ) 
  ...
  local YouMoney =guiCreateLabel(40, 10, 100, 20, "Ваши деньги:", false, scrollpane)
...
guiSetFont (YouItemsText, "default-bold-small" )
 ...
 aaa5= guiGridListAddColumn( aaa3, "Цена покупки", 0.15 )
...
if teri == "Торговец: транспорт"   or itemList=="Мото транспорт(черный рынок)" or itemList=="Легковой транспорт(черный рынок)" or itemList=="Грузовой транспорт(черный рынок)" or  itemList =="Воздушный транспорт(черный рынок)" then 
