...
y=y+B  aTab1.VehicleHealth	= guiCreateLabel ( 0.26, y, 0.25, 0.04, "Vehicle Health: 0%", true, aTab1.Tab )
		...
		guiSetEnabled(aTab2.ResourceDelete,false)
		...
		guiSetEnabled(aTab3.SetGameType,false)	
		...
		guiSetEnabled(aTab3.Shutdown,false)
		...
		guiSetEnabled(aTab3.WeatherDec,false)
		...
		guiSetEnabled(aTab3.WeatherInc,false)
		...
		guiSetEnabled(aTab3.WeatherSet,false)
		guiSetEnabled(aTab3.WeatherBlend,false)
						  local th, tm = getTime()
		...
		guiSetEnabled(aTab3.TimeSet,false)
		...
		guiSetEnabled(aTab3.GravitySet,false)
		...
		guiSetEnabled(aTab3.SpeedSet,false)
		...
		guiSetEnabled(aTab3.WavesSet,false)
		...
		guiSetEnabled(aTab3.FPSSet,false)			 	 
